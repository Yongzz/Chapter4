...
public class TotalPayCalculatorTest extends TestCase{
    ...
    public void testName() throws Exception {
        ...
        ((HourlyEmployee) hEmp[0]).setEmployeeDetails("Yongama", "Ngwenduna", "2/05/2006", "Programmer", 12, 20.00);
        ((SalariedEmployee)hEmp[1]).setEmployeeDetails("Thule","Xoliseka","05/08/2003","Analisty",15000);

        assertEquals(15240.0, tot.calcTotalPay(hEmp));
